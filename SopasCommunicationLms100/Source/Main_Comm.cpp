...
static void SopasAsyncCallback(const SDecodedAnswer& rAnswer, CBinaryDataStream& rStream, CDeserializer& rDeserializer);
...
int main(int argc, char* argv[])
{
  ...
  {
    printf("Invalid commandline. Only IP-address allowed as parameter. Using default.\n");
  }
...
void InitLms100(CLms100SopasInterface& rSopas)
{
  ...
  if(rSopas.SetScanConfig(5000, 5000, -450000, 2250000, &eError) == true)
  {
...
void SopasAsyncCallback(const SDecodedAnswer& rAnswer, CBinaryDataStream& rStream, CDeserializer& rDeserializer)
{
